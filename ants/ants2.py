...
class Place:
        ...
        def add_insect(self, insect):
                ...
                if insect.is_ant:
                        ...
                        if self.ant != None and self.ant.can_contain(insect):
                                ...
                                insect, self.ant = self.ant, insect                        # swap
                                self.ant.contain_ant(insect)
                        else:
                                assert self.ant is None, 'Two ants in {0}'.format(self)
                                self.ant = insect
        ...
        def remove_insect(self, insect):
                ...
                if insect.is_ant:
                        ...
                        elif self.ant.__class__ is not QueenAnt or self.ant.impostor == True:
                                self.ant = None
                else:
...
class Bee(Insect):
        ...
        name = 'Bee'
        watersafe = True        # override the Insect class variable
...
class Ant(Insect):
        ...
        damage = 0
        food_cost = 0
        blocks_path = True                # the bees can't fly by this spot
        container = False                # indicats whether an ant cancontain another
        ...
        def can_contain(self, other):
                ...
                3. the other ant is not container"""
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while cur_place != hive:
            if len(cur_place.bees) != 0 and index >= self.min_range and index <= self.max_range:
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        Place.add_insect(self, insect)      # inherit
...
class NinjaAnt(Ant):
        ...
        damage = 1
        implemented = True
        blocks_path = False                # the bees can fly through the NinjaAnt
        food_cost = 6                        # override
...
class ScubaThrower(ThrowerAnt):
        """ScubaThrower would not lose it armor when placed in Water"""
        name = "Scuba"
        food_cost = 5
        watersafe = True                # override the class attribute
        implemenmted = True
...
class QueenAnt(ScubaThrower):  # You should change this line
        ...
        def action(self, colony):
                ...
                pos = self.place
                if pos.ant.container is True and pos.ant not in QueenAnt.double_lst:
                        pos.ant.damage *= 2
                        QueenAnt.double_lst.append(pos.ant)
                while pos.entrance != None:
                        if pos.entrance.ant != None and pos.entrance.ant not in QueenAnt.double_lst:
                                pos.entrance.ant.damage *= 2
                                if pos.entrance.ant.container is True and pos.entrance.ant.ant != None:
                                        pos.entrance.ant.ant.damage *= 2
                                        QueenAnt.double_lst.append(pos.entrance.ant.ant)
                                QueenAnt.double_lst.append(pos.entrance.ant)
                        pos = pos.entrance
                pos = self.place
                while pos.exit != None:
                        if pos.exit.ant != None and pos.exit.ant not in QueenAnt.double_lst:
                                pos.exit.ant.damage *= 2
                                if pos.exit.ant.container is True and pos.exit.ant.ant != None:
                                        pos.exit.ant.ant.damage *= 2
                                        QueenAnt.double_lst.append(pos.exit.ant.ant)
                                QueenAnt.double_lst.append(pos.exit.ant)
                        pos = pos.exit
